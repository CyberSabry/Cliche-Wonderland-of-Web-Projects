...
// Adds a specified animation class to the given element, triggering the associated CSS animation.
...
export default { createHTML, resetInput, appendChildren, hide, show, remove, placeCursorAtEnd, animate };